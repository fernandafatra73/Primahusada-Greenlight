  ...
  return (
    <div className="page-frame page-frame--pink">
      ...
      >
        ...
        <button type="button" onClick={() => onNavigate('alternatif-exness')} style={cardStyle}>
          <span style={{ fontSize: '2rem' }}>📉</span>
          <span>Alternatif Exness</span>
        </button>
        ...
        <button type="button" onClick={() => onNavigate('global-warm')} style={cardStyle}>
          <span style={{ fontSize: '2rem' }}>🏦</span>
